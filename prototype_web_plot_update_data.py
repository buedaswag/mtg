...
for card_name, file_name in zip(card_names, file_names):
    ...
    with open('/home/mig/mtg/app/app/pickles/' + file_name + '_item_cheapest_price_item_amount.pickle', 'wb') as handle:
    ...
    with open('/home/mig/mtg/app/app/pickles/' + file_name + '_price_distribution_lastest_time_stamp.pickle', 'wb') as handle:
        pickle.dump(list_pickle, handle, protocol=pickle.HIGHEST_PROTOCOL)
